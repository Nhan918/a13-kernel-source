...
SRCU_NOTIFIER_HEAD_STATIC(fsys0_throughput_notifier);
...
SRCU_NOTIFIER_HEAD_STATIC(fsys0_throughput_max_notifier);
...
#endif
>>>>>>> 6f23950978f5 (qos: Remove pm_qos_update_request_timeout() API)
